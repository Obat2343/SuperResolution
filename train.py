...
def main():
    ...
    parser.add_argument('l','--log_step', type=int, default=50, help='')
    parser.add_argument('-s','--save_step', type=int, default=1000, help='')
    parser.add_argument('-e','--eval_step', type=int, default=1000, help='')
